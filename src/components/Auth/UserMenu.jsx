...
function UserMenu({ user, syncStatus, onSignOut, onSyncNow, lastSynced }) {
        ...
        <div className="user-dropdown">
          ...
          {!isAnon && (
            <button
              ...
              className="dd-item"
              style={{ width: '100%', textAlign: 'left', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text)', fontSize: 13, display: 'flex', alignItems: 'center', gap: 8 }}
          ...
          <button
            ...
            className="dd-item"
            style={{ width: '100%', textAlign: 'left', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--red)', fontSize: 13, display: 'flex', alignItems: 'center', gap: 8 }}
          >
            <I.LogOut size={14} />
