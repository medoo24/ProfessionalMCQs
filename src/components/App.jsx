...
function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {showNarration && <NarrationMode questions={questions} displaySettings={displaySettings} favIds={favIds} completedIds={completedIds} weakIds={weakIds} onToggleFav={toggleFav} onToggleDone={toggleDone} onClose={() => setShowNarration(false)} />}
